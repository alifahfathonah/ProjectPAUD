...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">+ Guru</button>
<br><br>
<!-- The Modal -->
        ...
        <div class="container-fluid">
           <form action="{{url('/home/datagurudanstaf')}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <p>No Hp</p>
                <input type="text" name="nohp" class="form-control"><input type="hidden" name="level" value="0">
                <p>Foto</p>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                @csrf @method('put')
                    ...
                    <p>No Hp</p>
                    <input type="text" name="nohp" class="form-control" value="{{ $t->nohp}}"><input type="hidden" name="level" value="0">
                    <p>Foto</p>
                    <input type="file" name="foto" class="form-control">
                    <br>
                    <input type="submit"  class="btn btn-default" value="Submit">
